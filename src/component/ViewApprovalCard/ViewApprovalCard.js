  ...
  if (status === "Pending") {
    return (
      <div className="viewpurchaseorder">
        ...
        <p>
          <b>Vendor Name</b>: {props.data.vendorForPurchaseOrder.vendorName}
        </p>
        ...
        <p>
          <b>Total Amount</b>: Rs.{props.data.purchaseOrderWithUsersName.total}
        </p>
        <p>
          <b>Ordered On</b>:{" "}
          {props.data.purchaseOrderWithUsersName.orderDateTime}
        ...
        <div className="address">
          <div>
            ...
            <p>
              ...
              {props.data.purchaseOrderWithUsersName.billingAddressCity}
            </p>
            <p>
              {props.data.purchaseOrderWithUsersName.billingAddressState},{" "}
              {props.data.purchaseOrderWithUsersName.billingAddressCountry}
            </p>
          ...
          <div>
            ...
            <p>
              {props.data.purchaseOrderWithUsersName.shippingAddress},{" "}
              {props.data.purchaseOrderWithUsersName.shippingAddressCity}
            </p>
            <p>
              {props.data.purchaseOrderWithUsersName.shippingAddressState},{" "}
              {props.data.purchaseOrderWithUsersName.shippingAddressCountry}
            </p>
            <p>
              {props.data.purchaseOrderWithUsersName.shippingAddressZipcode}
            </p>
          </div>
        </div>
